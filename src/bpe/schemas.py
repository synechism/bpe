...
from bpe.inert_orchestration import JSON_SCHEMAS as INERT_ORCHESTRATION_JSON_SCHEMAS
...
JSON_SCHEMAS: dict[str, type[BaseModel]] = {
    ...
    **INERT_ORCHESTRATION_JSON_SCHEMAS,
    **ORACLE_JSON_SCHEMAS,
...
if len(JSON_SCHEMAS) != (
    ...
    + len(INERT_ORCHESTRATION_JSON_SCHEMAS)
